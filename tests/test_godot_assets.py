...
class GodotAssetTests(unittest.TestCase):
    ...
    def test_arena_scene_references_existing_scripts(self):
        ...
        self.assertEqual(
            sorted(script_paths),
            ["scripts/arena_3d.gd", "scripts/network_session.gd"],
        )
    ...
    def test_client_uses_authoritative_protocol_and_signature(self):
        ...
        self.assertIn('"lobby.list"', network)
        self.assertIn('"action.play_edge"', network)
